...
@section("contentheader_title", trans("messages.officer regular salary"))
@section("contentheader_description", trans("messages.Officer Regular Salary desc"))
@section("htmlheader_title", trans("messages.officer regular salary"))
@section("headerElems")
@endsection
