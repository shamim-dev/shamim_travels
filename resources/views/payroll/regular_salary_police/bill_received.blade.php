...
<html>
  <head>
    ...
    <table>
    	...
    	<tr>
    		<td rowspan="10"></td>
    		<td rowspan="10"><p>র‍্যাব ফোর্সেস সদর দপ্তর, ঢাকায় কর্মরত ৩৮২ জন র‍্যাব সদস্যদের (পুলিশ, বিজিবি, আনসার ও বেসামরিক) জানুয়ারি ২০১৭ মাসের নিয়মিত বেতন ভাতা বিল ।
          </p>
          <br>
          <br>
          <br>
          ...
          <br>
          <br>
          <p>বিল নং ______________/২০১৬-২০১৭  </p>
        </td>
        <td>মূল বেতন</td>
        <td></td>
    	</tr>
