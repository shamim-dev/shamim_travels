<?php use App\Helpers\CommonHelper; ?>
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				...
				@else
					<li class="dropdown tasks-menu"><a data-toggle="dropdown" class="dropdown-toggle" href="#" ><span class="">@lang('messages.Language')</span> <i class="fa fa-caret-down"></i></a>
	              		<ul class="dropdown-menu">
					...
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="{{ asset('la-assets/img/user_no_image.jpg') }}" class="user-image" alt="User Image"/>
