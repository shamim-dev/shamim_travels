...
@section('contentheader_description') @lang('messages.Organization Overview') @endsection
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="#" class="small-box-footer">@lang('messages.More info') <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box bg-green">
                ...
                <a href="#" class="small-box-footer">@lang('messages.More info') <i class="fa fa-arrow-circle-right"></i></a>
                {{-- {{ url(config('laraadmin.adminRoute') . '/battalions') }} --}}
              </div>
            </div><!-- ./col -->
