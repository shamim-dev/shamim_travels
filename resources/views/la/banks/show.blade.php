			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'bank_name')
						@la_display($module, 'bank_short_name')
						@la_display($module, 'bank_address')
						@la_display($module, 'bank_cell_no')
						@la_display($module, 'bank_mobile')
						@la_display($module, 'bank_email')
						@la_display($module, 'bank_website')
					</div>
				</div>
			</div>
		</div>		
