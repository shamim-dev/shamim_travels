...
class ModuleController extends Controller
{
	...
	public function generate_crud($module_id)
	{
		...
		$menu = Menu::get($module->name);  // get menu_id to set permission for Super Admin
 		
		// Give Default Full Access to Super Admin
		$role = Role::where("name", "SUPER_ADMIN")->first();
		//Module::setDefaultRoleAccess($module->id, $role->id, "full");
		Module::setDefaultRoleAccess($module->id, $menu, $role->id, "full"); // default access for menu also
	}
